...
export const Route = createFileRoute('/career/$career-id/subject/$subject-id/new-document')({
...
function NewDocument() {
  ...
  function handleSubmit(e: any) {
    ...
    createDocument.mutate(
      ...
      {
        onSuccess: (ref) => {
          navigate({ to: '/career/$career-id/subject/$subject-id/document/$document-id', params: { 'career-id': careerId, 'subject-id': subjectId, 'document-id': ref.id } })
        },
      },
    )
  }
