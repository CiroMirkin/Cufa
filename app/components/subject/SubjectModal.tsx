      ...
      <View className="flex-1 items-center justify-center bg-black/40 px-6">
        <View className="w-full rounded-xl bg-white p-5">
          ...
          <TextInput
            ...
            autoFocus
            className="rounded-lg border border-neutral-300 p-3 text-sm text-neutral-800"
          />
          <View className="mt-4 flex-row justify-end gap-3">
            <Pressable onPress={onClose} className="px-4 py-2">
              <Text className="text-sm text-neutral-500">Cancelar</Text>
            </Pressable>
            <Pressable onPress={handleCreate} className="rounded-lg bg-neutral-900 px-4 py-2">
